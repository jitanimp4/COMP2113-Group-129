...
/**
 * Constructs the game object, seeds random engine, and initializes pointers.
 * Input parameters: none.
 * Return value: none.
 */
WordPyramidGame::WordPyramidGame() : activePuzzle(NULL) {
  std::random_device rd;
  rng.seed(rd());
}

/**
 * Releases dynamically allocated puzzle memory.
 * Input parameters: none.
 * Return value: none.
 */
...
/**
 * Loads words from a text file (one word per line), converts to uppercase.
 * Input parameters:
 * - fileName: path of file to load.
 * - words: output vector filled with loaded words.
 * Return value:
 * - true if file opened and at least one word loaded, false otherwise.
 */
